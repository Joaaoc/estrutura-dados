...
// Aloca espaço na memória do tamanho de "Teste" e declarando o valor solicitado pelo usuário ao nó inicial 
...
int main()
{
	...
	while (1)
	{
		...
		{
			lista = excluirNoInicio(lista);
		}
		else if (command == 7)
		{
			lista = excluirNoFinal(lista);
		}
		else if (command == 8)
		{
			printf("Digite a posicao: ");
